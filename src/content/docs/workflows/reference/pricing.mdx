...
Steps and storage billing for Workflows will go live on August 1st, 2026 at the earliest.
...
- Deleting instances via the [Workers API](/workflows/build/workers-api/), [Wrangler CLI](/workers/wrangler/commands/workflows/#workflows), REST API, or dashboard will free up storage. Note that it may take a few minutes for storage limits to update.
