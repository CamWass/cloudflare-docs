...
This setup is ideal if your email provider is not Microsoft 365 or Google Workspace, or you do not want to directly integrate your account. Beware that manually add does not support [auto-move](/cloudflare-one/email-security/settings/auto-moves/) or [directory synchronization](/cloudflare-one/email-security/directories/).
...
1. Log in to [Cloudflare dashboard](https://dash.cloudflare.com/) > **Email security**.
