...
On the [Cloudflare dashboard](https://dash.cloudflare.com/), upload the `.json` file downloaded on step 3.
...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Integrations**.

   <DashButton url="/?to=/:account/integrations" zeroTrust />
