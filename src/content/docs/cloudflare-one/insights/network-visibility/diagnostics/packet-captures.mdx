...
1. In the [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Network visibility** > **Diagnostics**.

   <DashButton url="/?to=/:account/insights/network-visibility/*" zeroTrust />
