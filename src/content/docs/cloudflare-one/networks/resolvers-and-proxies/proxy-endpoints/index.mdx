...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Networks** > **Resolvers & Proxies**, then go to **Proxy endpoints**.
...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Networks** > **Resolvers & Proxies**.
